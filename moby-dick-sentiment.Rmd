...
```{r, include=FALSE}
setwd("~/Desktop/git-space/hacking-moby-dick/") #Here you'll want to use the proper path to where your moby-dick.txt file lives, so if you download it to your desktop, your path would be something like "~/Desktop/moby-dick.txt"
library(XML)
library(tidytext)
library(dplyr)
library(stringr)
...
```{r}
words <- data_frame(file = paste0("~/Desktop/git-space/hacking-moby-dick/", 
                                        c("moby-dick.txt"))) %>%
